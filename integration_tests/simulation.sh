...
killall server # zakonczenie procesu serwera
echo "Test 1 stop"
...
./server >> integration_tests/sim_server.txt &  # wlaczenie serwera
sleep 1
./sensors 2 2 2 > integration_tests/sim2_sensors.txt & # uruchomienie sensora i przekierowanie do pliku
sleep 3
...
sleep 1
./control_mod para 2 2 10 >> integration_tests/sim3_control.txt # zmiana czasu dla czujnika o typie 2 i numerze 2
sleep 1
